...
{
    public class RequestManagerHomeController : Controller
    {
        private readonly ILogger<RequestManagerHomeController> _logger;
        private readonly ApplicationDbContext _context;
        private readonly IWebHostEnvironment _webHostEnvironment;

        public RequestManagerHomeController(ILogger<RequestManagerHomeController> logger, ApplicationDbContext context, IWebHostEnvironment webHostEnvironment)
        {
            _logger = logger;
            _context = context;
        ...
        public IActionResult ReqManagerProfile()
        {
        ...
        public IActionResult UpdateProfilePicture(IFormFile file)
        {
            ...
            if (file != null && file.Length > 0)
            {
                ...
                _context.SaveChanges();
                return RedirectToAction("SecurityProfile", "HomeSecurity", new { area = "Security_Personnel" });
