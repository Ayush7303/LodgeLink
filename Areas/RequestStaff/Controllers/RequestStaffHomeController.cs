using LodgeLink.Areas.RequestManager.Controllers;
...
{
    public class RequestStaffHomeController : Controller
    {
        private readonly ILogger<RequestStaffHomeController> _logger;
        private readonly ApplicationDbContext _context;
        private readonly IWebHostEnvironment _webHostEnvironment;
        public RequestStaffHomeController(ILogger<RequestStaffHomeController> logger, ApplicationDbContext context, IWebHostEnvironment webHostEnvironment)
        {
            _logger = logger;
            _context = context;
        ...
        public IActionResult ReqStaffProfile()
        {
        ...
        public IActionResult UpdateProfilePicture(IFormFile file)
        {
            ...
            if (file != null && file.Length > 0)
            {
                ...
                _context.SaveChanges();
                return RedirectToAction("ReqStaffProfile", "RequestStaffHome", new { area = "RequestStaff" });
