...
namespace LodgeLink.Areas.Security_Personnel.Controllers
{
    ...
    {
        private readonly ILogger<HomeSecurityController> _logger;
        private readonly ApplicationDbContext _context;
        private readonly IWebHostEnvironment _webHostEnvironment;

        public HomeSecurityController(ILogger<HomeSecurityController> logger, ApplicationDbContext context, IWebHostEnvironment webHostEnvironment)
        {
            _logger = logger;
            _context = context;
        ...
        public IActionResult Index()
        {
            ...
            //var profilepic = (from s in _context.users
            //                  where s.UserId == uid
            //                  select s.ProfilePicture).FirstOrDefault();
            
            //ViewBag.pp = profilepic;
            //ViewBag.Uname = uname;
            return View();
        }
