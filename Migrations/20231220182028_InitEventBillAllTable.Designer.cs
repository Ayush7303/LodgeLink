...
namespace LodgeLink.Migrations
{
    ...
    [Migration("20231220182028_InitEventBillAllTable")]
    partial class InitEventBillAllTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LodgeLink.Models.Bill", b =>
                {
                    ...
                    b.ToTable("Bill", t =>
                        {
                            t.HasTrigger("After_Bill_Create");
                        });
                });

            modelBuilder.Entity("LodgeLink.Models.BillsPayment", b =>
                {
            ...
            modelBuilder.Entity("LodgeLink.Models.EventParticipant", b =>
                {
            ...
            modelBuilder.Entity("LodgeLink.Models.BillsPayment", b =>
                {
                    b.HasOne("LodgeLink.Models.Bill", "Bill")
                        .WithMany()
            ...
            modelBuilder.Entity("LodgeLink.Models.EventParticipant", b =>
                {
                    b.HasOne("LodgeLink.Models.Event", "Event")
                        .WithMany()
